...
ax = grid[0]
ax.imshow(real_corr[0,:,:], origin ='lower', vmin = corr_length[-1,0].min(), vmax =corr_length[-1,0].max())

ax2 = grid[1]
ax2.imshow(real_corr[1,:,:], origin ='lower', vmin = corr_length[-1,1].min(), vmax =corr_length[-1,1].max())

ax3 = grid[2]
ax3.imshow(real_corr[2,:,:], origin ='lower', vmin = corr_length[-1,2].min(), vmax =corr_length[-1,2].max())
