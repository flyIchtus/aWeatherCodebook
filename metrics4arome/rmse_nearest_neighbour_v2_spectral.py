...
data_dir_r = '/scratch/mrmn/poulainauzeaul/Exp_StyleGAN/IS_1_1.0_0_0_0_0_0_256_done_with_8_var/'
data_dir_f = '/scratch/mrmn/poulainauzeaul/Exp_StyleGAN/Set_38/resnet_128_wgan-hinge_64_8_1_0.0001_0.0001/Instance_1/samples/' # chnage to yours

Means = np.load(data_dir_r+'mean_with_8_var.npy')[1:4].reshape(3,1,1)
Maxs = np.load(data_dir_r+'max_with_8_var.npy')[1:4].reshape(3,1,1)
